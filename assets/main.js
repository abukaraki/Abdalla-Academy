const ui = {
  ar: {
    ...
    materialsDesc: "ملفات PDF وZIP ومرفقات المحاضرات مرتبة حسب الدورة والدرس.",
    ...
    materialsPageTitle: "مكتبة ملفات المحاضرات",
    materialsPageLead: "PDF وZIP وملفات تدريبية مرتبة حسب الدورة والمحاضرة.",
  ...
  en: {
    ...
    materialsDesc: "PDF, ZIP, and lecture attachments organized by course and lesson.",
    ...
    materialsPageTitle: "Lecture File Library",
    materialsPageLead: "PDF, ZIP, and practice files organized by course and lesson.",
...
function formatTerminalLine(line, cursor) {
  ...
  const statusMatch = escaped.match(/^(password:|access granted|status:|auth:|run:|scan:|ai:|deploy:|build:|preview:|compile:|coach:)(.*)$/i);
