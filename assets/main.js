const ui = {
  ar: {
    ...
    terms: "الشروط",
    heroEyebrow: "تعلم بوضوح، ابن مهارتك بثقة",
    heroTitle: "منصة تعليمية للمحاضرات والمقالات والبرمجة.",
    heroLead: "",
  ...
  en: {
    ...
    terms: "Terms",
    heroEyebrow: "Learn clearly, build with confidence",
    heroTitle: "An educational platform for lectures, articles, and programming.",
    heroLead: "",
